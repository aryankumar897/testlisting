...
const ProductGallery = () => {
  ...
  const fetchGallery = async () => {
    try {
      setLoading(true);
      const res = await fetch(`${process.env.API}/admin/listing-gallery?listing_id=${id}`);
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      // Save to database
      const saveRes = await fetch(`${process.env.API}/admin/listing-gallery`, {
        method: "POST",
  ...
  const handleDeleteImage = async () => {
    try {
      const res = await fetch(`${process.env.API}/admin/listing-gallery/${imageToDelete}`, {
        method: "DELETE",
      });
