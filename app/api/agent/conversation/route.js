...
//       .sort({ createdAt: 1 })
//       .populate('sender_id', 'name email image') // Populate sender with specific fields
//       .populate('receiver_id', 'name email image') // Populate receiver with specific fields
//       .populate('listing_id', 'title image thumbnail_image price is_verified status views address') // Populate listing with specific fields
//       .lean(); // Convert to plain JavaScript objects

//     console.log("Fetched messages with populated data:", messages[0]);
